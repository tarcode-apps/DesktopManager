...
Name: "AutoRunRegistry"; Description: "{cm:AutoStartProgram,{#AppName}}"; GroupDescription: "{cm:AutoStartProgramGroupDescription}"; Check: not IsPortableOnly
...
[Registry]
;current user only
Root: "HKCU"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "{#AppName}"; ValueData: "{app}\{#MainFileName}"; Flags: uninsdeletevalue; Tasks: AutoRunRegistry; Check: not IsElevated; BeforeInstall: DelAutorun
;any user
Root: "HKLM"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "{#AppName}"; ValueData: "{app}\{#MainFileName}"; Flags: uninsdeletevalue; Tasks: AutoRunRegistry; Check: IsElevated; BeforeInstall: DelAutorun
